...
class CalculadoraSolar(MDApp):
    ...
    dados_consumo = [['Aparelho de blu ray', 24, '2 h', '0,57'],
       ...
       ['Ar-cond. janela menor 9k BTU/h', 30,
        '8 h', '128,8'],
       ['Ar-cond. janela de 9k a 14k BTU/h', 30, '8 h',
        '181,6'],
       ['Ar-cond. janela maior que 14k BTU/h', 30, '8 h',
        '374'],
       ['Ar-cond. split de 10k a 15k BTU/h', 30, '8 h',
        '193,76'],
       ['Ar-cond. split de 15k a 20k BTU/h', 30, '8 h',
        '293,68'],
       ['Ar-cond. split de 20k a 30k BTU/h', 30, '8 h',
        '439,2'],
       ['Ar-cond. split maior que 30k BTU/h', 30, '8 h',
        '679,2'],
