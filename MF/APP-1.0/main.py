...
class CalculadoraSolar(MDApp):
    ...
    dados_consumo = [['Aparelho de blu ray', 24, '2 h', '0,57'],
       ['Aparelho de DVD', 24, '2 h', '0,72'],
       ['Aparelho de som', 20, '3 h', '6,6'],
       ['Aquecedor de ambiente', 30, '8 h', '386,88'],
       ['Aquecedor de marmita', 20, '30 min', '0,6'],
       ['Ar-condicionado - janela menor 9 kBTU/h', 30,
        '8 h', '128,8'],
       ['Ar-condicionado - janela de 9k a 14k BTU/h', 30, '8 h',
        '181,6'],
       ['Ar-condicionado - janela maior que 14k BTU/h', 30, '8 h',
        '374'],
       ['Ar-condicionado - split de 10k a 15k BTU/h', 30, '8 h',
        '193,76'],
       ['Ar-condicionado - split de 15k a 20k BTU/h', 30, '8 h',
        '293,68'],
       ['Ar-condicionado - split de 20k a 30k BTU/h', 30, '8 h',
        '439,2'],
       ['Ar-condicionado - split maior que 30k BTU/h', 30, '8 h',
        '679,2'],
       ['Aspirador de pó', 30, '20 min', '7,17'],
       ['Batedeira', 24, '20 min', '1,2'],
       ...
       ['Fritadeira elétrica', 30, '30 min', '13,62'],
       ['Furadeira', 32, '1 h', '11,28'],
       ...
       ['Grill', 10, '30 min', '3,2'],
       ['Home theater - 350 W', 3, '2 h', '16,8'],
       ['Impressora', 30, '1 h', '0,45'],
       ['Lâmpada fluorescente - 11 W', 30, '5 h', '1,65'],
       ['Lâmpada fluorescente - 15 W', 30, '5 h', '2,25'],
       ['Lâmpada fluorescente - 23 W', 30, '5 h', '3,45'],
       ...
       ['Secadora de roupa', 24, '1 h', '44,76'],
       ['Tanquinho', 32, '1 h', '2,52'],
